...
overview: |
  This project presents a **hybrid econometric–AI framework** for predicting Airtel Africa’s stock prices by integrating **Generalized Autoregressive Conditional Heteroskedasticity (GARCH)** models with modern **deep learning architectures** such as LSTM, GRU, Transformer, BiGRU, and GRU-Attention.
  The goal is to combine statistical volatility modeling with neural sequence learning for more accurate and interpretable financial forecasting.
...
model_architectures:
  ...
  best_model:
    ...
    metrics:
      ...
      MAPE: "2.13%"
      R2: 0.8898
    highlight: "Outperformed all baseline and hybrid GARCH models."
...
dataset_access: |
  The dataset is directly imported in the Colab notebook using **Yahoo Finance API**.
  Users can fetch the same data by running:
...
enabling more dynamic short-term forecasts.
...
"Add explainability using SHAP and LIME for model interpretation."
